...
const ComponentDataSource = (props) => {
  ...
  const [datasourceData,setDatasourceData] = useState({
    ...
    customer_total_device_count:0,
    customer_total_device_log_count:0,
  })
  ...
  const reportStartDate = userDataContext.selectedCustomer.length > 0 ? userDataContext.selectedCustomer[0].reportStartDate : null
  const reportEndDate = userDataContext.selectedCustomer.length > 0 ? userDataContext.selectedCustomer[0].reportEndDate : null
